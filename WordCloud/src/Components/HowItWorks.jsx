...
import { PencilSquareIcon, QrCodeIcon, ChartBarIcon } from '@heroicons/react/24/outline';

const steps = [
  {
    name: 'Create',
    description: 'Use templates or start from scratch to build interactive slides.',
